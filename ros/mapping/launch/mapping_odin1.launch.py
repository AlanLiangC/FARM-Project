...
def generate_launch_description() -> LaunchDescription:
    args = [
        ...
        DeclareLaunchArgument("depth_encoding", default_value="32FC1"),
        DeclareLaunchArgument("max_sensor_age_s", default_value="0.0"),
        DeclareLaunchArgument("cloud_coordinates", default_value="world"),
    ...
    depth_pub = Node(
        ...
        parameters=[{
            ...
            "max_sensor_age_s": LaunchConfiguration("max_sensor_age_s"),
            "cloud_coordinates": LaunchConfiguration("cloud_coordinates"),
